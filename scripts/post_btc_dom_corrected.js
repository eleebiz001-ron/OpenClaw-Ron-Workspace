...
async function postWithSingleImage() {
  try {
    // 오직 차트 이미지(file_78)만 업로드
    const mediaId = await client.v1.uploadMedia('/Users/ieunchul/.openclaw/media/inbound/file_78---e9838129-fd5f-4a38-a155-d10feeef21a2.jpg');
    ...
    console.log('Successfully posted corrected tweet:', tweet.data.id);
  } catch (error) {
