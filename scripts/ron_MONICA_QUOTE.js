...
`;
  ...
  try {
    ...
    const postContent = `Institutional trust is built on consistency. #RLUSD isn’t just a stablecoin; it’s the bridge to a higher standard of capital efficiency. Precision in regulatory alignment is what makes @Ripple the winner in the institutional race. 🇺🇸🥇 #XRP #XRPCommunityDay

https://x.com/MonicaLongSF/status/1881772103206134067`;
